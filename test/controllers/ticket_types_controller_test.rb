...
class TicketTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ticket_type" do
    assert_difference('TicketType.count') do
      post ticket_types_url, params: { ticket_type: { description: @ticket_type.description, event_id: @ticket_type.event_id, float: @ticket_type.float, max_tickets: @ticket_type.max_tickets, name: @ticket_type.name } }
    end
  ...
  test "should update ticket_type" do
    patch ticket_type_url(@ticket_type), params: { ticket_type: { description: @ticket_type.description, event_id: @ticket_type.event_id, float: @ticket_type.float, max_tickets: @ticket_type.max_tickets, name: @ticket_type.name } }
